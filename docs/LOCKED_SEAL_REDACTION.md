...
**DECIDED — WARN (Mark, confirmed repeatedly; recorded S492).** Not open. Do not re-ask.
...
Blocking is defensible given Mark's "reports must never appear stamped" position — but Mark has
decided: **WARN**. Build to warn.
