...
**I-9. One report row per person per review.** Separate inspectors on the same review each get their own record (structural isolation saved two of three reports on 7155.40). Review number is shared; records are not. Live co-editing of one record by multiple people is forbidden until an approved, field-verified design exists.
