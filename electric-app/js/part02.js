    ...
    import '/lib/ui/electricHelpCards.js';   /* ELECTRIC: its own help content, already in lib */
    ...
    try { if (typeof _helpSetDot === 'function' && window._helpHasUnseen) _helpSetDot(window._helpHasUnseen('Electric')); } catch(e){}
