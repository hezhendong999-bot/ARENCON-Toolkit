...
function _styleOnce() {
  ...
  st.textContent = [
    ...
    '.exv-mall{background:var(--smoke,#F0EDE6);font-weight:700;}',
    ...
    '.exv-mct{font-size:calc(12px + var(--ts,0px));color:var(--steel,#7A8699);font-variant-numeric:tabular-nums;}',
    '.exv-mhint{font-size:calc(11px + var(--ts,0px));color:var(--steel,#7A8699);padding:8px 12px;background:var(--smoke,#F0EDE6);}',
