...
// S260: Day/night icon now matches the Diesel tool EXACTLY — emoji glyph,
// diesel mapping. Diesel shows ☀️ in dark mode (tap to go light) and 🌙 in
// light mode (tap to go dark) i.e. the icon = the mode you'll switch TO.
// (Supersedes the S251b custom-PNG decision: parity with Diesel was requested.)
var _SUN_ICON = "\u2600\uFE0F";   // ☀️ shown in DARK mode (tap = go light)
var _MOON_ICON = "\uD83C\uDF19";  // 🌙 shown in LIGHT mode (tap = go dark)

function updateDarkToggleIcon() {
  var isDark = document.body.classList.contains('dark-mode');
  var icon = isDark ? _SUN_ICON : _MOON_ICON;
