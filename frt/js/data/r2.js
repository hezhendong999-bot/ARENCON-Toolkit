...
export var R2 = {
   ...
   *
   * Non-photo keys (drawings /frt/markup/, PDF buffers /frt/pdfbufs/, drawing
   * renders /frt/drawings/) are NOT this class and pass straight through — they
   * have their own share-checks (see deleteDrawingAsset).
   *
  ...
  delPhotoGuarded: function(r2Key, opts) {
    ...
    var isPhotoImage = (r2Key.indexOf('/frt/original/') >= 0) || (r2Key.indexOf('/frt/marked/') >= 0);
    if (!isPhotoImage) {
