/* ARENCON /lib/ — Image Compression Worker (S446 Step-4 extraction)
   VERBATIM from FRT frt/js/workers/imageWorker.js. Off-thread resize +
   JPEG re-encode via OffscreenCanvas. NOTE: the OffscreenCanvas project-ban
   protects iPad Safari; iPad is abandoned (Android-only field tablets) so the
   S130 waiver applies HERE, and imageWorkerHost keeps a main-thread fallback
   for environments without it. imports './imageWorker.js' sibling only. */
/**
