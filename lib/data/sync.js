...
var _LWW_SPECS = {
  ...
  frt: {
    arrays: {
      ...
      generalDeficiencies: { key: 'id', nested: { observations: { key: 'id' }, photos: { key: 'id', fields: ['caption','rotation','deleted','delAt','delState','deletedBy','_annotated','_markupStrokes','_mkFrame','_origBackupId'] } } },   // S541; S608/S612 photo fields
  ...
  Object.keys(nestedSpec).forEach(function (cf) {
    ...
    cOrder.forEach(function (k) {
      ...
      if (xc && xl) {
        ...
        if (_lwwItemEmpty(xl) && !_lwwHasDeleteEvidence(xl)) { stats.droppedEmptyAbsent = (stats.droppedEmptyAbsent||0)+1; }   /* S611 */
      ...
      order.forEach(function (k) {
        ...
        if (c && l) {
          ...
          /* S611 — absence never deletes CONTENT; an EMPTY item with no delete
            ...
            if (_lwwItemEmpty(l) && !_lwwHasDeleteEvidence(l)) { stats.droppedEmptyAbsent = (stats.droppedEmptyAbsent||0)+1; }
    ...
    spec.fieldMaps.forEach(function (field) {
      ...
      Object.keys(keys).forEach(function (k) {
        ...
        /* S610 — a blank local field marked "dirty" (boot skeleton, unloaded
           ...
           mass wipes are not.) */
        if ((lv == null || lv === '') && cv != null && cv !== '') { out[k] = cv; return; }
        if (dirty) {
