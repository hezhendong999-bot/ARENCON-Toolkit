...
var _LWW_SPECS = {
  ...
  frt: {
    arrays: {
      ...
      contractors:         { key: 'id', nested: { deficiencies: { key: 'id', nested: { observations: { key: 'id' }, photos: { key: 'id' } } } } },
      generalDeficiencies: { key: 'id', nested: { observations: { key: 'id' }, photos: { key: 'id' } } },   // S541
...
function _lwwStripFields(o, fields) {
  ...
  for (var i = 0; i < fields.length; i++) {
    var f = fields[i];
    if (o[f] !== undefined) out[f] = (o[f] === null) ? '' : String(o[f]);
  }
