  ...
  if (typeof window !== 'undefined') window.ArcBootArbitrate = function (cloud, local, toolKey) {
    ...
    try {
      ...
      (spec.scalars || []).forEach(function (f) {
        ...
        if ((lR[f] || 0) <= (cR[f] || 0)) return;                 // cloud newer or unstamped — leave it
        ...
        cloud._fts._root[f] = lR[f];                              // the winner's own stamp travels
