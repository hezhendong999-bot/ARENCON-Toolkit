...
t('B01 version is 2.6.0', () => eq(ENGINE2_VERSION, '2.6.0'));
...
t('E13 drawer order: meter placed directly above the icon row', () => {
  const rb = src.slice(src.indexOf('function _rebuildDrawer'), src.indexOf('function refit'));
  ok(rb.indexOf('meter.node') < rb.indexOf('iconrow') && rb.indexOf('rest.forEach') < rb.indexOf('meter.node'));
});
