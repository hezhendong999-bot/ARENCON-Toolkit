...
t('B01 version is 2.7.0', () => eq(ENGINE2_VERSION, '2.7.0'));
...
t('E07 fold avail RESERVES the left minimum (no self-referential measure)', () =>
  ok(src.includes('const TITLE_MIN = 60') && src.includes('reserved += c.offsetWidth')));
...
t('E14 Load + Export All live in More (no standalone header buttons)', () =>
