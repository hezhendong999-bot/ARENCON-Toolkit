...
t('B01 version is 2.3.0', () => eq(ENGINE2_VERSION, '2.3.0'));
...
t('D06 save stamp pixels verbatim (10.5px, .5 white)', () =>
  ok(src.includes('font-size:10.5px') && src.includes('rgba(255,255,255,.5)')));
...
t('D13 FRT config: 5 repair items, 3 admin-gated', () => {
  eq((frt.match(/adminOnly:true/g)||[]).length, 3);
