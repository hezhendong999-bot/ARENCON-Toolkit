...
export function portalHeaderConfig(h) {
  ...
  return {
    ...
    actions: [
      /* Help (S505 pattern, verbatim from headerConfigs.js/hubHeaderConfig.js —
         S679-U2): amber "?" at rest; wn-dot hidden until cards exist and
         hasUnseen() flips it. The portal ships coming-soon until its card set
         is Owner-reviewed. */
      { key: 'help', type: 'icon', id: 'btn-help', foldGroup: 'icons', foldRank: 6,
        icon: '<span class="help-q">?</span><span class="wn-dot" style="display:none"></span>',
        title: 'Help & guide', drawerLabel: 'Help', onClick: h.onHelp || null },
