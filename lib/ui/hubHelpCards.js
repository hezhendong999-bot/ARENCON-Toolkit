...
/* ═══ PROJECTS BOARD ═══ */
{
  id:'board-fresh', area:'Projects board', date:'2026-08-09', isNew:true,
  title:'The board keeps itself current',
  pts:['The board used to be a photograph — whatever it showed when you opened it, it kept showing.',
       'Now it <b>reloads whenever you come back to it</b>: switching tabs, waking the tablet, or returning from a report.',
       'While it is on screen it also <b>re-checks every 30 seconds</b>, so a star, a tool switch, a new report or a status change made by someone else appears on its own.',
       'It stays still while you are typing, while a dialog is open, or while you have projects ticked for a bulk action — it will never move the page under your thumb.',
       'Two people on the board see each other within about half a minute. It is not instant; if that ever matters, say so.'],
  chips:[['New','c-new'],['Everyone','c-where']],
  terms:'stale old out of date not updating refresh reload F5 someone else starred did not appear my colleague changed it board frozen not showing changes live update sync two people at once same time',
  compact:true
},
{
...
{
  id:'one-tab', area:'Reports', date:'2026-08-09', isNew:true,
  title:'Reports open in this tab',
  pts:['Opening a report <b>replaces the board in the same tab</b>. Back inside the report brings you here again.',
       'You no longer collect a row of leftover Dashboard tabs over a day of work.',
       'Want two side by side? <b>Ctrl+click</b> (or middle-click) a report to open a second copy in its own tab.',
       'Opening the <b>same</b> report a second way still jumps to the copy already open — two tabs on one report silently overwrite each other, so that protection stays.'],
  chips:[['New','c-new'],['Everyone','c-where']],
  terms:'two tabs opened twice overwrite lost work my changes vanished someone overwrote conflict same report open twice duplicate window lost edits disappeared typing too many tabs new tab same tab back button pile of tabs',
