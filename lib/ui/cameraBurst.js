/* ARENCON /lib/ — Camera Burst (S446 Step-4 extraction)
   VERBATIM from FRT frt/js/ui/cameraBurst.js. Pure UI, ZERO data-layer
   coupling (no Model/R2/IDB/Auth). SACRED, carried byte-for-byte:
     • S424 gravity-sensor orientation (TWA portrait-lock workaround)
     • S341 adaptive 4096x3072 4:3 capture (12MP crashed Android WebView)
     • S428-S433 flash/torch 3-state + S431 torch-lens hunt
     • Plain canvas only — never OffscreenCanvas (iPad/TWA)
   Single export openCameraBurst(); caller owns persistence via callback. */
/**
