  ...
  return {
    ...
    actions:[
      ...
      /* S492 COLOUR FIX (Mark). A plain text entry inherits the engine's base
         ...
         in BOTH modes.
         Palette is the canonical muted set — navy #2C4770 for the three
         "where am I going" controls, teal for utility, slate for More. No
         burgundy: brand red is reserved for primary CTAs, never header nav. */
      { key:'admin', type:'text', id:'btn-admin', label:'&#128100; Admin',
        bg:'#2C4770', title:'Admin panel', drawerLabel:'Admin Panel',
        onClick:h.onAdmin || null },

      { key:'profile', type:'text', id:'btn-profile', label:'&#9881;&#65039; Profile',
        bg:'#2C4770', title:'Your profile', drawerLabel:'Profile',
        onClick:h.onProfile || null },

      { key:'tools', type:'text', id:'btn-tools', label:'&#129520; Tools',
        bg:'#2E8C8C', title:'All ARENCON tools', drawerLabel:'All Tools',
