  ...
  return {
    ...
    actions:[
      ...
      { key:'profile', type:'text', id:'btn-profile', label:'&#9881;&#65039; Profile',
        bg:'#4A4750', title:'Your profile', drawerLabel:'Profile',
      ...
      { key:'signout', type:'text', id:'btn-signout', label:'&#128275; Sign Out',
        bg:'#0F766E', title:'Sign Out', isSignout:true, drawerLabel:'Sign Out',
