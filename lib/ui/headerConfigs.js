...
export function frtHeaderConfig(h){
  ...
  return {
    ...
    actions:[
      ...
      { key:'load', type:'text', id:'btn-load', label:'📂 Load', title:'Load JSON', drawerLabel:'Load', bg:'#455A64', hidden:true, onClick:null },
      { key:'exportall', type:'text', id:'btn-export-all', label:'📦 Export All', title:'Export All Projects', drawerLabel:'Export All', bg:'#455A64', hidden:true, onClick:null },
