  ...
  return {
    ...
    actions:[
      ...
      { key:'more', type:'menu', id:'btn-more-wrap-btn', wrapId:'btn-more-wrap', menuId:'more-menu',
        ...
        items:[
          { label:'Download JSON', onClick:h.onDownloadJSON||null },
          { label:'Export Project Docs', onClick:h.onExportDocs||null },
          { label:'Import JSON', onClick:h.onImportJSON||null },
...
export function electricHeaderConfig(h){
  ...
  return {
    ...
    logoSrc:h.logoSrc||'', homeHref:'../ARENCON_Project_Hub.html', defaultTheme:'light',
    onBack:h.onBack||null, onHome:h.onHome||null,
    actions:[
      _navArrows(h.onUndo, h.onRedo),
      { key:'idb', type:'meter', id:'storage-display', fillId:'idb-bar-fill', title:'Browser storage usage', drawerLabel:'Storage usage' },
      ...
      { key:'ai', type:'menu', id:'btn-ai-review', wrapId:'ai-review-wrap', menuId:'ai-mode-menu',
        label:'✨ AI Review ▾', bg:'#7d1f35', title:'AI Review', drawerLabel:'AI Review',
        items:[ { label:'Review All', sub:'Deficiencies, responses & notes', onClick:h.onAiReviewAll||null } ]},
      { key:'reports', type:'menu', id:'btn-reports-parent', wrapId:'btn-reports-wrap', menuId:'reports-menu',
        label:'📄 Reports ▾', bg:'#1A237E', title:'Reports', drawerLabel:'Reports',
        items:[
          { label:'Issue Report', onClick:h.onIssue||null },
