  ...
  return {
    ...
    actions:[
      ...
      { key:'ai', type:'menu', id:'btn-ai-review', wrapId:'ai-review-wrap', menuId:'ai-mode-menu',
        label:'✨ AI Review ▾', bg:'#7B2D8E', title:'AI text review', drawerLabel:'AI Review',   /* S488: purple (Mark) */
        items:[
...
export function frtHeaderConfig(h){
  ...
  return {
    ...
    actions:[
      ...
      { key:'ai', type:'menu', label:'&#10024; AI Review &#9662;', bg:'#7B2D8E',   /* S488 (Mark): purple stays — the S455 burgundy standardization is REVERSED for AI Review */
      ...
      { key:'more', type:'menu', label:'&#9881;&#65039; More &#9662;', bg:'#455A64',
        ...
        items:[
          ...
          { label:'&#128230; Export All Projects', sub:'Download every project as JSON', onClick:h.onExportAll||null },
          { divider:true },
          { label:'&#128190; Download JSON', sub:'Save project data to file', hubOnly:true, onClick:h.onDownloadJSON||null },
          { label:'&#128230; Export Project Docs', sub:'ZIP: photos + JSON + README', onClick:h.onExportDocs||null },
