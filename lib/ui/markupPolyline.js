...
(function (root) {
  ...
  function create(config) {
    ...
    return {
      ...
      /* Hosts that paint the preview inline (no overlay layer — e.g. the FRT
         photo lightbox, which repaints one canvas each frame) read the pending
         points from here. */
      pointAt: function (i) { return points[i]; },
      points: function () { return points.slice(); },
