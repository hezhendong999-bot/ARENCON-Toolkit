...
ART.tests = svg(300,190,
  ...
  + t(16,118,'7-POINT — adds the in-betweens + VFD',{s:6.5,w:700,f:INK3})
...
},
{
  ...
  pts:['One <b>Performance Test</b> tab holds both — switch with the toggle at the top.',
       '3-point is the straight churn / rated / 150% run; the 7-point tab is the <b>VFD</b> test — it adds the in-between readings and the pressure-limiting check.',
       '<b>Voltage and amps are recorded at each point</b> alongside the pressures.'],
  chips:[['New','c-new'],['Everyone','c-where']],
  terms:'3 point 7 point three seven flow test performance toggle switch which test vfd variable speed drive pld device 25 50 75 125 rows churn rated 150 voltage amps difference',
  art:ART.tests
},
{
