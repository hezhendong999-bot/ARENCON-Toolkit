 ...
 * two-SET pick/group model + S459e grab-band pad + S461 contour halo).
...
(function (root) {
  ...
  var M = {
    ...
    _drawSelHalo:function(ctx, s, k, active){
      ...
      if(pathed){
        ...
        ctx.globalAlpha = active ? 0.58 : 0.42;
        ctx.strokeStyle = active ? '#EF9F27' : '#E6A23C';
  ...
  var API = { install: install, VERSION: '2.1.0' };
