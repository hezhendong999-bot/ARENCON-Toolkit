...
(function (root) {
  ...
  var API = { install: install, VERSION: '2.10.2' };   // 2.10.2 = S487f tap-member deferred deselect; 2.10.1 = S487d F1-tap box-grab; 2.10.0 = S487 F1 whole-interior grab; 2.9.0 = S479 polyline contour halo
