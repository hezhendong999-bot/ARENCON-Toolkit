...
(function (root) {
  ...
  var SEL = {
    // HALO — cool bright glow around the ink. Deliberately NOT amber any more:
    // amber-on-yellow ink was nearly invisible, and yellow is a common ink here.
    // Cyan-white pops against the whole ink palette (red / orange / yellow) and
  ...
  var API = { install: install, VERSION: '2.2.0' };
