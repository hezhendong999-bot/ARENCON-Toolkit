...
(function (root) {
  ...
  var M = {
    ...
    _selMove:function(p){
      ...
      if(ds.type==='resizeAxis'){
        ...
        var fA=Math.max(0.1,Math.min(10,Math.abs(_cur-aA)/Math.max(1,Math.abs(_st-aA))));
  ...
  var API = { install: install, VERSION: '2.11.1' };   // 2.11.1 = S487i mid anchors at geometry edge; 2.11.0 = S487h mid-edge single-axis handles; 2.10.2 = S487f tap-member deferred deselect; 2.10.1 = S487d F1-tap box-grab; 2.10.0 = S487 F1 whole-interior grab; 2.9.0 = S479 polyline contour halo
