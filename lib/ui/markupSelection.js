...
(function (root) {
  ...
  var M = {
    ...
    _selDown:function(p, ev){
      ...
      if(g){
        ...
        // v2.11.0 (S487h): mid-edge handles — SINGLE-AXIS scale. Anchor is the
        // OPPOSITE edge; only that axis stretches. mids = [top, right, bottom, left].
        var _axAnchors=[['y',g.b.y2],['x',g.b.x1],['y',g.b.y1],['x',g.b.x2]];
  ...
  var API = { install: install, VERSION: '2.11.0' };   // 2.11.0 = S487h mid-edge single-axis handles; 2.10.2 = S487f tap-member deferred deselect; 2.10.1 = S487d F1-tap box-grab; 2.10.0 = S487 F1 whole-interior grab; 2.9.0 = S479 polyline contour halo
