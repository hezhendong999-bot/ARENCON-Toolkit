...
(function (root) {
  ...
  var M = {
    ...
    _groupBounds:function(){
      ...
      this.selIds.forEach(function(id){
        var s=self._findStroke(id); if(!s) return; var b=self._selHooks.aabb.call(self, s); any=true;
      ...
      if(ds && ds.type==='rubberband' && this._rubberBand){
        ...
        if(Math.abs(rx2-rx1)>4||Math.abs(ry2-ry1)>4){
          ...
          this.strokes.forEach(function(s){
            var b=self._selHooks.aabb.call(self, s);
    ...
    _drawSelChrome:function(ctx){
      ...
      if(inTap && this.selIds && this.selIds.length){
        ...
        ctx.save();
        this.selIds.forEach(function(id){ var s=selfG._findStroke(id); if(!s) return; var b=selfG._selHooks.aabb.call(selfG, s);
  ...
  var API = { install: install, VERSION: '2.0.0' };
