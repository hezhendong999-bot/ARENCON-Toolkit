...
export const DIALOG_ENGINE_VERSION = '1.0.0';
...
/* ── Header: low-alpha tint + bordered icon chip. Never a heavy solid bar. ── */
.hd{
  display:flex; align-items:center; gap:11px;
  padding: 14px 16px;
  background: color-mix(in srgb, var(--acc) 9%, transparent);
  border-bottom: 1px solid color-mix(in srgb, var(--acc) 22%, var(--dlg-line));
}
.chip{
  flex:0 0 auto;
...
.ttl{
  ...
  letter-spacing:.1px; margin:0; flex:1 1 auto;
}
...
function _mount(opts) {
  ...
  scrim.innerHTML =
    '<div class="card" role="dialog" aria-modal="true" style="--acc:' + accent +
...
export const Dlg = {
  ...
  alert, confirm, confirmDanger, typeToConfirm, prompt, leave, progress, form, pickList
};
