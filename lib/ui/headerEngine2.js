...
export const ENGINE2_VERSION = '2.11.0';
...
export function buildHeader2(mountEl, cfg){
  ...
  const paintMe = () => {
    ...
    meMenu.innerHTML =
      ...
      + `<button class="mi" data-act="account">&#9881;&nbsp; Account</button>`
      + `<div class="misep"></div>`
  ...
  function refit(){
    ...
    const avail = barW - reserved - (moreBtn.offsetWidth || 42) - 12;
    ...
    const pinned = !!(cfg.onHome || cfg.homeHref);
    moreBtn.classList.toggle('has-folded', folded.length > 0 || pinned);
