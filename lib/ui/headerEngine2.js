...
export const ENGINE2_VERSION = '2.8.0';
...
:host([data-skin="chrome"]) .back{
  /* S505: hardcoded — see base .back note. This is the light header Mark uses.
     S521 (Mark): these values are the SAME BUTTON as lib/ui/backButton.js
     (BACK_CSS), which the drawing viewer renders in a sealed shadow root.
     They are a matched pair — change both in one commit or they drift, which
     is exactly what produced eight rounds of "not the same button". */
  background:#EFEDF0; border:1px solid #D2CEDB; color:#1B1A22;
